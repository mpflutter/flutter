    ...
    if (b == null) {
      ...
      if (a == null) {
        ...
        return Color.fromARGB(
          clampInt(_lerpInt(a.alpha, b.alpha, t).toInt(), 0, 255),
          clampInt(_lerpInt(a.red, b.red, t).toInt(), 0, 255),
          clampInt(_lerpInt(a.green, b.green, t).toInt(), 0, 255),
          clampInt(_lerpInt(a.blue, b.blue, t).toInt(), 0, 255),
        );
      }
    }
  }
...
abstract class Gradient extends Shader {
  factory Gradient.linear(
    ...
    Float64List? matrix4,
      ...
      MockGradientLinear(from, to, colors, colorStops, tileMode, matrix4);
  factory Gradient.radial(
    ...
    final Float32List? matrix32 = matrix4 != null ? toMatrix32(matrix4) : null;
    if (focal == null || (focal == center && focalRadius == 0.0)) {
      return MockGradientRadial(
      ...
      return MockGradientConical(focal, focalRadius, center, radius, colors,
  ...
  factory Gradient.sweep(
    ...
    Float64List? matrix4,
      ...
      MockGradientSweep(center, colors, colorStops, tileMode, startAngle,
          endAngle, matrix4 != null ? toMatrix32(matrix4) : null);
}
...
class Codec {
  ...
  String? _getNextFrame(dynamic callback) => null;
  void dispose() {}
}
...
Future<Codec?> webOnlyInstantiateImageCodecFromUrl(Uri uri,
    {dynamic? chunkCallback}) async {
  return null;
}

String? _instantiateImageCodecFromUrl(
  Uri uri,
  dynamic? chunkCallback,
  dynamic callback,
) {
  return null;
}
...
void decodeImageFromPixels(
  ...
  final Future<Codec> codecFuture = _futurize((dynamic callback) {
